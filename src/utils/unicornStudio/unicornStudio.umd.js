...
var De = (n, e, t) =>
  e in n
    ...
    : (n[e] = t)
var z = (n, e, t) => (De(n, typeof e != 'symbol' ? e + '' : e, t), t)
let re = 0
function g() {
  if (!(re > 100)) {
    if (re === 100)
  ...
  setPlaneRenderOrder(e) {
    ...
    if (e.target)
      ...
      !this.renderer.depth || s
        ? (t.sort((i, r) => r.index - i.index),
          e._transparent &&
            t.sort((i, r) => i.relativeTranslation.z - r.relativeTranslation.z),
          t.sort((i, r) => i.renderOrder - r.renderOrder))
        : (t.sort((i, r) => i.index - r.index),
          e._transparent &&
...
class Fe {
  constructor({
    ...
    if (
      ((this.gl = this.canvas.getContext('webgl2', p)),
  ...
  removeRenderTarget(e) {
    ...
    let t = this.planes.find(
      (s) => s.type !== 'PingPongPlane' && s.target && s.target.uuid === e.uuid
    )
    ...
    switch (e.type) {
      ...
      default:
        this.renderer.production ||
          g(this.type + ': This uniform type is not handled : ', e.type)
    }
  }
  /***
...
class pe {
  constructor(e, { parent: t, vertexShader: s, fragmentShader: i } = {}) {
    ...
    ;(this.renderer = e),
      (this.gl = this.renderer.gl),
      (this.parent = t),
      (this.defaultVsCode = this.parent.type === 'Plane' ? Xe : Qe),
      (this.defaultFsCode = this.parent.type === 'Plane' ? Ye : Ze),
      s
        ? (this.vsCode = s)
        : (!this.renderer.production &&
...
`,
  ...
  /***
       ...
       ***/
  createUniforms(e) {
    ;(this.uniformsManager = new Ne(this.renderer, this.program, e)),
      this.setUniforms()
  }
  /***
...
class Ke {
  ...
  initAttributes() {
    for (const e in this.attributes) {
      if (
        ((this.attributes[e].isActive = this.program.activeAttributes.includes(
...
class B {
  ...
  composeFromOrigin(e, t, s, i) {
    ...
    return (
      ...
      (r[10] = ue),
      (r[11] = 0),
      (r[12] = e.x + M - (D * M + H * E + de * R)),
      (r[13] = e.y + E - (V * M + C * E + ce * R)),
      (r[14] = e.z + R - (W * M + le * E + ue * R)),
      (r[15] = 1),
      this
    )
  }
...
class S {
  ...
  applyQuat(e) {
    const t = this._x,
      ...
      u = -r * t - a * s - h * i
    return (
      (this._x = l * o + u * -r + d * -h - c * -a),
      (this._y = d * o + u * -a + c * -r - l * -h),
      (this._z = c * o + u * -h + l * -a - d * -r),
      this
    )
  }
  /***
  ...
  unproject(e) {
    return (
      this.applyMat4(e.projectionMatrix.getInverse()).applyMat4(e.worldMatrix),
      this
    )
  }
}
...
class j {
  ...
  copy(e) {
    if (!e || e.type !== 'Texture') {
      this.renderer.production ||
        g(this.type + ': Unable to set the texture from texture:', e)
      return
    }
...
gl.LINEAR filtering will be used instead`
  ...
  setScale(e) {
    ...
    e.sanitizeNaNValuesWith(this.scale).max(ae.set(1e-3, 1e-3)),
  ...
  _updateTextureMatrix(e) {
    ...
    ;(t.x /= this.scale.x),
      (t.y /= this.scale.y),
      (this._textureMatrix.matrix = et.setFromArray([
        t.x,
        0,
        0,
        0,
  ...
  loadImage(e, t = {}, s, i) {
    ...
    if (
      ...
      ;(a.sampler =
        typeof e != 'string' && e.hasAttribute('data-sampler')
          ...
          : a.sampler),
        (a.fromTexture = r)
      const d = new j(this.renderer, a)
      this._sourceLoaded(r.source, d, s),
        this._parent && this._addToParent(d, r.source, 'image')
      return
    }
    const h = this._createImage(e)
    a.sampler = h.hasAttribute('data-sampler')
      ? h.getAttribute('data-sampler')
      : a.sampler
    const o = new j(this.renderer, a),
    ...
    h.complete
      ...
      ? h
          ...
          .catch(() => {
            h.addEventListener('load', l.load, !1),
              h.addEventListener('error', l.error, !1)
          })
      : (h.addEventListener('load', l.load, !1),
        h.addEventListener('error', l.error, !1)),
  ...
  loadVideo(e, t = {}, s, i) {
    ...
    r.addEventListener('canplaythrough', o.load, !1),
      ...
      'requestVideoFrameCallback' in HTMLVideoElement.prototype &&
        ...
        (h._videoFrameCallbackID = r.requestVideoFrameCallback(
  ...
  constructor(
    ...
    super(e, t.crossOrigin),
      ...
      this._parent.type !== 'Plane' &&
        ...
        (g(this.type + ': Wrong parent type assigned to this loader'),
        (this._parent = null)),
...
class it {
  constructor(
    ...
    ;(this._canDraw = !1),
      ...
      (o = parseInt(o)),
      (l = parseInt(l)),
      (this._geometry = new Ke(this.renderer, {
        width: o,
        height: l,
  ...
  _initMesh() {
    ;(this.uuid = he()),
      (this.loader = new st(this.renderer, this, {
        sourcesLoaded: 0,
        initSourcesToLoad: 0,
  ...
  /***
       ...
       ***/
  createTexture(e = {}) {
    const t = new j(this.renderer, Object.assign(e, this._texturesOptions))
    ...
    for (let e = 0; e < this.textures.length; e++) {
      ...
      if (t.sourceType === 'video') {
        ...
        s !== void 0 &&
          s.catch((i) => {
            this.renderer.production ||
              g(this.type + ': Could not play the video : ', i)
          })
      }
    }
  }
...
class at extends it {
  ...
  mouseToPlaneCoords(e) {
    const t = this.scale ? this.scale : rt.set(1, 1),
      s = ge.set(
      ...
      i = {
        width:
          (this._boundingRect.document.width * t.x) / this.renderer.pixelRatio,
        height:
          (this._boundingRect.document.height * t.y) / this.renderer.pixelRatio,
...
class Te extends at {
  ...
  _initTransformValues() {
    ;(this.rotation = new S()),
      ...
      (this.relativeTranslation = new S()),
      this.relativeTranslation.onChange(() => this._setTranslation()),
      (this._translation = new S()),
      (this.scale = new S(1)),
      this.scale.onChange(() => {
        ;(this.scale.z = 1), this._applyScale()
      }),
      (this.transformOrigin = new S(0.5, 0.5, 0)),
  ...
  setScale(e) {
    ...
    e.sanitizeNaNValuesWith(this.scale).max(ht.set(1e-3, 1e-3)),
  ...
  _getNearPlaneIntersections(e, t, s) {
    ...
    if (s.length === 1)
      s[0] === 0
        ? ((t[0] = this._getIntersection(t[1], k.set(0.95, 1, 0).applyMat4(i))),
          t.push(this._getIntersection(t[3], F.set(-1, -0.95, 0).applyMat4(i))))
        : s[0] === 1
        ? ((t[1] = this._getIntersection(
            t[0],
            k.set(-0.95, 1, 0).applyMat4(i)
          )),
          t.push(this._getIntersection(t[2], F.set(1, -0.95, 0).applyMat4(i))))
        : s[0] === 2
        ? ((t[2] = this._getIntersection(
            t[3],
            k.set(-0.95, -1, 0).applyMat4(i)
          )),
          t.push(this._getIntersection(t[1], F.set(1, 0.95, 0).applyMat4(i))))
        : s[0] === 3 &&
          ((t[3] = this._getIntersection(
            t[2],
            k.set(0.95, -1, 0).applyMat4(i)
          )),
          t.push(this._getIntersection(t[0], F.set(-1, 0.95, 0).applyMat4(i))))
    else if (s.length === 2)
      s[0] === 0 && s[1] === 1
        ? ((t[0] = this._getIntersection(
            t[3],
            k.set(-1, -0.95, 0).applyMat4(i)
          )),
          (t[1] = this._getIntersection(t[2], F.set(1, -0.95, 0).applyMat4(i))))
        : s[0] === 1 && s[1] === 2
        ? ((t[1] = this._getIntersection(
            t[0],
            k.set(-0.95, 1, 0).applyMat4(i)
          ...
          (t[2] = this._getIntersection(
            t[3],
            F.set(-0.95, -1, 0).applyMat4(i)
          )))
        : s[0] === 2 && s[1] === 3
        ? ((t[2] = this._getIntersection(t[1], k.set(1, 0.95, 0).applyMat4(i))),
          (t[3] = this._getIntersection(t[0], F.set(-1, 0.95, 0).applyMat4(i))))
        : s[0] === 0 &&
          s[1] === 3 &&
          ((t[0] = this._getIntersection(t[1], k.set(0.95, 1, 0).applyMat4(i))),
          (t[3] = this._getIntersection(t[2], F.set(0.95, -1, 0).applyMat4(i))))
    else if (s.length === 3) {
      let r = 0
      ...
      ;(t = [t[r]]),
        r === 0
          ? (t.push(
              this._getIntersection(t[0], k.set(-0.95, 1, 0).applyMat4(i))
            ),
            t.push(
              this._getIntersection(t[0], F.set(-1, 0.95, 0).applyMat4(i))
            ))
          : r === 1
          ? (t.push(
              this._getIntersection(t[0], k.set(0.95, 1, 0).applyMat4(i))
  ...
  mouseToPlaneCoords(e) {
    if (
      ...
      me.equals(this.quaternion) && pt.equals(this.transformOrigin))
    )
  ...
  _createFrameBuffer() {
    ;(this._frameBuffer = this.gl.createFramebuffer()),
      ...
      this.textures.length
        ...
        : new j(this.renderer, this._texturesOptions).addParent(this),
...
const $ = (n, e, t) => n * (1 - t) + e * t,
  Re = (n, e, t, s) => Math.sqrt(Math.pow(n - t, 2) + Math.pow(e - s, 2)),
  bt = (n, e, t, s) => (s - t) / (e - n)
function Pt(n) {
  return n
    .map((e, t) =>
...
const wt = (n, e) => {
    ...
    let i = 0
    for (let r = 1; r < s; r++) {
      const a = Re(n[r][0], n[r][1], n[r - 1][0], n[r - 1][1])
      a <= e / 2
        ? i < e / 2
          ? (i += a)
          : (t.push([
            ...
            (i = 0))
        : t.push([$(n[r - 1][0], n[r][0], 0.5), $(n[r - 1][1], n[r][1], 0.5)])
    }
    return t.push(n[s]), t
  },
  Tt = (n, e) => {
  ...
  xe = {
    ...
    OVERLAY:
      'vec3((dst.x <= 0.5) ? (2.0 * src.x * dst.x) : (1.0 - 2.0 * (1.0 - dst.x) * (1.0 - src.x)), (dst.y <= 0.5) ? (2.0 * src.y * dst.y) : (1.0 - 2.0 * (1.0 - dst.y) * (1.0 - src.y)), (dst.z <= 0.5) ? (2.0 * src.z * dst.z) : (1.0 - 2.0 * (1.0 - dst.z) * (1.0 - src.z)))',
    DARKEN: 'min(src, dst)',
    LIGHTEN: 'max(src, dst)',
    COLOR_DODGE:
      'vec3((src.x == 1.0) ? 1.0 : min(1.0, dst.x / (1.0 - src.x)), (src.y == 1.0) ? 1.0 : min(1.0, dst.y / (1.0 - src.y)), (src.z == 1.0) ? 1.0 : min(1.0, dst.z / (1.0 - src.z)))',
    COLOR_BURN:
      'vec3((src.x == 0.0) ? 0.0 : (1.0 - ((1.0 - dst.x) / src.x)), (src.y == 0.0) ? 0.0 : (1.0 - ((1.0 - dst.y) / src.y)), (src.z == 0.0) ? 0.0 : (1.0 - ((1.0 - dst.z) / src.z)))',
    LINEAR_BURN: '(src + dst) - 1.0',
    HARD_LIGHT:
      'vec3((src.x <= 0.5) ? (2.0 * src.x * dst.x) : (1.0 - 2.0 * (1.0 - src.x) * (1.0 - dst.x)), (src.y <= 0.5) ? (2.0 * src.y * dst.y) : (1.0 - 2.0 * (1.0 - src.y) * (1.0 - dst.y)),  (src.z <= 0.5) ? (2.0 * src.z * dst.z) : (1.0 - 2.0 * (1.0 - src.z) * (1.0 - dst.z)))',
    SOFT_LIGHT:
      'vec3((src.x <= 0.5) ? (dst.x - (1.0 - 2.0 * src.x) * dst.x * (1.0 - dst.x)) : (((src.x > 0.5) && (dst.x <= 0.25)) ? (dst.x + (2.0 * src.x - 1.0) * (4.0 * dst.x * (4.0 * dst.x + 1.0) * (dst.x - 1.0) + 7.0 * dst.x)) : (dst.x + (2.0 * src.x - 1.0) * (sqrt(dst.x) - dst.x))), (src.y <= 0.5) ? (dst.y - (1.0 - 2.0 * src.y) * dst.y * (1.0 - dst.y)) : (((src.y > 0.5) && (dst.y <= 0.25)) ? (dst.y + (2.0 * src.y - 1.0) * (4.0 * dst.y * (4.0 * dst.y + 1.0) * (dst.y - 1.0) + 7.0 * dst.y)) : (dst.y + (2.0 * src.y - 1.0) * (sqrt(dst.y) - dst.y))), (src.z <= 0.5) ? (dst.z - (1.0 - 2.0 * src.z) * dst.z * (1.0 - dst.z)) : (((src.z > 0.5) && (dst.z <= 0.25)) ? (dst.z + (2.0 * src.z - 1.0) * (4.0 * dst.z * (4.0 * dst.z + 1.0) * (dst.z - 1.0) + 7.0 * dst.z)) : (dst.z + (2.0 * src.z - 1.0) * (sqrt(dst.z) - dst.z))))',
    DIFFERENCE: 'abs(dst - src)',
    EXCLUSION: 'src + dst - 2.0 * src * dst',
    LINEAR_LIGHT: '2.0 * src + dst - 1.0',
    PIN_LIGHT:
      'vec3((src.x > 0.5) ? max(dst.x, 2.0 * (src.x - 0.5)) : min(dst.x, 2.0 * src.x), (src.x > 0.5) ? max(dst.y, 2.0 * (src.y - 0.5)) : min(dst.y, 2.0 * src.y), (src.z > 0.5) ? max(dst.z, 2.0 * (src.z - 0.5)) : min(dst.z, 2.0 * src.z))',
    VIDID_LIGHT:
      'vec3((src.x <= 0.5) ? (1.0 - (1.0 - dst.x) / (2.0 * src.x)) : (dst.x / (2.0 * (1.0 - src.x))), (src.y <= 0.5) ? (1.0 - (1.0 - dst.y) / (2.0 * src.y)) : (dst.y / (2.0 * (1.0 - src.y))), (src.z <= 0.5) ? (1.0 - (1.0 - dst.z) / (2.0 * src.z)) : (dst.z / (2.0 * (1.0 - src.z))))',
  }
let Se = ''
...
`,
  St = {
    ...
    EASE_IN_OUT_QUART:
      't < 0.5 ? 8.0 * t * t * t * t : 1.0 - 8.0 * (--t) * t * t * t',
    EASE_IN_QUINT: 't * t * t * t * t',
    EASE_OUT_QUINT: '1.0 + (--t) * t * t * t * t',
    EASE_IN_OUT_QUINT:
      't < 0.5 ? 16.0 * t * t * t * t * t : 1.0 + 16.0 * (--t) * t * t * t * t',
  ...
  function (n, e, t) {
    ...
    function r(h, o, l, d, c, u, f) {
      o === void 0 &&
        ...
        d === void 0 && (d = 0),
        c === void 0 && (c = 0),
        u === void 0 && (u = 2 * Math.PI),
        f === void 0 && (f = !1)
      var m = Math.floor((180 * c) / Math.PI),
        x = Math.ceil((180 * u) / Math.PI),
      ...
      y.translate(l, d)
      for (
        var b = (2 * Math.PI * (_ + 20)) / 360,
          w = new i.default(o, x - m + 1),
          P = m;
        P <= x;
        P++
      )
        y.save(),
          y.rotate(((f ? -1 : 1) * (Math.PI * P)) / 180),
          y.beginPath(),
          y.moveTo(0, 0),
          y.lineTo(_, -2 * b),
          y.lineTo(_, 0),
      ...
      return (
        ...
        A.lineTo(l, d),
        A.closePath(),
        (A.fillStyle = A.createPattern(v, 'no-repeat')),
        A.fill(),
...
typeof document.hidden < 'u'
  ? ((Z = 'hidden'), (K = 'visibilitychange'))
  : typeof document.msHidden < 'u'
  ? ((Z = 'msHidden'), (K = 'msvisibilitychange'))
  : typeof document.webkitHidden < 'u' &&
    ((Z = 'webkitHidden'), (K = 'webkitvisibilitychange'))
const Dt = {
  NORMAL: 'Normal',
  ADD: 'Add',
  SUBTRACT: 'Subtract',
...
function Lt(n) {
  ...
  let s = n.coords.map(([i, r]) =>
    It(e.center.x, e.center.y, i, r, -n.rotation * 360)
  )
...
function X(n) {
  ...
  let t =
      ...
      n.compiledFragmentShaders.filter(
        (i) => i.match(/uMousePos/g) && i.match(/uMousePos/g).length > 1
      ).length,
    s = n.layerType === 'effect' && n.animating
  return e || t || s
}
function zt(n, e, t) {
  const s = []
...
function Ft(n, e) {
  if (n.length) {
    ...
    for (let s = 0; s < n.length; s++) {
      let i = ['normal', 'regular'].includes(n[s].fontStyle)
        ? ''
        : `:wght@${n[s].fontStyle}`
      n[s].fontStyle === 'italic' && (i = ''),
        ...
        @font-face {
          ...
          : (t.innerHTML += `@import url(https://fonts.googleapis.com/css2?family=${n[
              s
            ].fontFamily
              .split(' ')
              .join('+')}${i});`)
...
function Ut(n, e) {
  const s =
      Q([e.offsetWidth || n.width, e.offsetHeight || n.height])[0] /
      e.offsetWidth,
...
function se() {
  ...
  const n = L.filter((t) => t.getAnimatingEffects().length),
    e = (t) => {
          ...
          ? (Zt(),
            s.forEach((i) => {
              i.curtain &&
                ...
                (Kt(), i.curtain.render(), (i.lastTime = t))
            }),
...
class Wt {
    ...
    ;(this.prop = e),
      ...
      typeof this.value == 'object' &&
        (this.value.type === 'Vec2'
          ? (this.value = new I(this.value._x, this.value._y))
          : this.value.type === 'Vec3' &&
            (this.value = new S(this.value._x, this.value._y, this.value._z)))
  }
  cloneVector(e) {
    let t
    return (
      e.type === 'Vec2'
        ? ((t = new I(e._x, e._y)), this.prop === 'pos' && (t.y = 1 - t.y))
        : e.type === 'Vec3' && (t = new S(e._x, e._y, e._z)),
      t
    )
  }
  initializeState(e, t) {
    if (
      ...
      if (typeof this.value == 'object') {
        let r
        this.value.type === 'Vec2'
          ? (r = new I(this.value._x, this.value._y))
          : this.value.type === 'Vec3' &&
            (r = new S(this.value._x, this.value._y, this.value._z)),
          (e.value = r)
  ...
  updateEffect(e, t) {
    ...
    if (this.complete || !e.userData.createdAt || !this.initialStateSet)
      return !1
    const i = e.uniforms[this.prop],
      r = Bt(this.transition.ease),
      a = e.userData.createdAt + this.transition.delay,
      h = Math.max(0, Math.min(1, (t - a) / this.transition.duration))
    let o = this.value
    if (h > 0 && h <= 1) {
      let l = r(h)
      s
        ? ((i.value.x = Y(o.x, this.endVal.x, l)),
          this.prop === 'pos'
            ? (i.value.y = Y(1 - o.y, this.endVal.y, l))
            : (i.value.y = Y(o.y, this.endVal.y, l)),
          o.type === 'Vec3' && (i.value.z = Y(o.z, this.endVal.z, l)))
        : (i.value = Y(o, this.endVal, l))
    } else s ? (i.value = this.cloneVector(this.value)) : (i.value = this.value)
    return (
      h >= 1 && ((this.complete = !0), (this.progress = 0)),
      (this.lastTick = t),
      !0
    )
  }
...
class Ce {
  ...
  state() {
    return L.find((e) => e.id === this.local.sceneId) || this.initOptions
  }
  getIndex() {
    return this.state()
      .history.map((e) => e.local.id)
  ...
  getMaskedItem() {
    return this.mask
      ? this.state().history.filter((e) => e.visible && !e.parentLayer)[
          this.getIndex() - 1
        ]
      : !1
  }
  getChildEffectItems() {
    return this.effects
      ? this.state().history.filter(
          (e) =>
            e.visible && e.parentLayer && this.effects.includes(e.parentLayer)
        )
      : []
  }
}
let ie = class extends Ce {
  ...
  createLocalCanvas() {
    ...
    const a =
        Q([t.element.offsetWidth, t.element.offsetHeight])[0] /
...
class Ht extends ie {
  ...
  unpackage() {
    return (
      (this.coords = U(this.coords)),
      (this.fill = U(this.fill)),
      (this.effects = U(this.effects)),
      this.coords.length > 3
        ? (this.coordsHiRes = _e(this.coords, this.size))
        : (this.coordsHiRes = this.coords),
      this
    )
  }
  interpolatePath() {
    ...
    if ((this.local.ctx.beginPath(), this.type === 'rectangle')) {
      ...
      if (t.length) {
        ...
        for (let d = 0; d < t.length; d++) {
          const [c, u] = t[d],
            ...
            [v, y] = r(i, 0, x)
          let p = l[d]
          this.local.ctx.lineTo(c - v * p, u - y * p),
            this.local.ctx.arcTo(c, u, f, m, i)
        }
      ...
      if (t.length >= 2) {
        const i = G(t),
          ...
          u = (r.height / Math.sqrt(3)) * 0.86
        this.local.ctx.beginPath()
        for (let f = 0; f < s; f++) {
          const x = -Math.PI / 2 + (2 * Math.PI * f) / s
          let v = o + c * Math.cos(x),
            y = h + u * Math.sin(x)
          ;([v, y] = l(v, y, d, o, h)),
            f === 0 ? this.local.ctx.moveTo(v, y) : this.local.ctx.lineTo(v, y)
        }
        this.local.ctx.closePath()
      }
    }
    ;(this.local.ctx.fillStyle = Me(this.local.ctx, this, t)),
      this.local.ctx.clearRect(
        0,
        0,
        this.state().canvasWidth,
      ...
      (this.states = {
        appear:
          t.states && t.states.appear
            ? t.states.appear.map((r) => new Wt(r))
            : [],
      })
  ...
  unpackage() {
    ...
    for (let t in this)
      this[t] &&
        this[t].type &&
        (this[t].type === 'Vec2'
          ? (this[t] = new I(this[t]._x, this[t]._y))
          : this[t].type === 'Vec3' &&
            (this[t] = new S(this[t]._x, this[t]._y, this[t]._z)))
    return this
  }
  getParent() {
    return this.state()
      .history.filter((t) => t.effects && t.effects.length)
            ...
            this.getPlane() &&
              this.getPlane()
                ...
                .forEach((i) => {
                  ;(i.shouldUpdate = !1),
                    this.rendering ||
                      (i.needUpdate(), this.state().curtain.render())
                })
        },
        !1
      ),
...
class jt extends ie {
  ...
  unpackage() {
    return (
      (this.fill = U(this.fill)),
      (this.highlight = U(this.highlight)),
      (this.coords = U(this.coords)),
      (this.effects = U(this.effects)),
      this
    )
  ...
  render() {
    ...
    ;(a = Math.max(a, u)),
      ...
      (this.local.ctx.fillStyle = Me(this.local.ctx, this, this.coords))
    const f = (p, _, b, w, P, T, A) => {
        let M = _.split('').reduce(
            (R, D, V) =>
              R + p.measureText(D).width + (V < _.length - 1 ? P : 0),
            0
          ),
          E
        if (
          (T === 'center' ? (E = b + (A - M) / 2 - A / 2) : (E = b),
          T === 'right')
        )
          for (let R = _.length - 1; R >= 0; R--) {
            const D = _[R]
            ;(E -= p.measureText(D).width),
              p.fillText(D, E, w),
              R > 0 && (E -= P)
          }
        else
      ...
      m = (p, _) => {
        let b = i + l * _ + l / 2 + o / 3
        this.isSafari
          ? f(this.local.ctx, p, s, b, this.letterSpacing, this.textAlign, a)
          : this.local.ctx.fillText(p, s, b)
      },
      x = this.textContent
...
`)
    ...
    const y = (p, _, b) =>
      _.split('').reduce(
        (P, T, A) => (
          (P += p.measureText(T).width), A < _.length - 1 && (P += b), P
        ),
        0
      )
    for (let p = 0; p < v; p++) {
...
`
          ...
          if (_ !== '')
            (x[p] = _.trim()),
              w !== b.length - 1
                ? (x.splice(p + 1, 0, b.slice(w).join('')), v++)
                : P !==
                    `
` && x.push(P)
          else {
            ...
            for (; M.length > 0; ) {
              ...
              for (
                let D = 0;
                D < M.length &&
                (this.local.ctx.measureText(R + M[D]).width <= a || D == 0);
                D++
              )
                R += M[D]
              ;(M = M.slice(R.length)),
                (x[E] = R.trim()),
                M.length > 0 && (x.splice(E + 1, 0, M), E++, v++)
            }
...
function $t(n) {
  Qt()
  const e = L.filter((s) => s.getAnimatingEffects().length),
    t = L.filter((s) => s.rendering)
...
function Zt() {
  L.forEach((n) => {
    n.isInView &&
      ...
      ((oe() &&
        n.interactivity &&
        n.interactivity.mouse &&
        n.interactivity.mouse.disableMobile) ||
        (n.interactivity.mouse.momentum
          ? ((n.mouse.pos.x = ye(
              n.mouse.movePos.x,
              n.mouse.lastPos.x,
              n.interactivity.mouse.momentum * 2
            )),
            (n.mouse.pos.y = ye(
              n.mouse.movePos.y,
              n.mouse.lastPos.y,
...
function Pe(n) {
  L.filter((e) => e.isInView).forEach((e) => {
    let t = e.curtain.container.getBoundingClientRect(),
      s,
      i
    n.targetTouches
...
class Jt {
  ...
  getAnimatingEffects() {
    return this.history.filter((e) => X(e) && e.visible)
  }
  createCurtains() {
  ...
  setInteractiveParams(e, t) {
    ...
    t &&
      t.mouse &&
      ('momentum' in t.mouse && (s.mouse.momentum = t.mouse.momentum),
      'disableMobile' in t.mouse &&
        (s.mouse.disableMobile = t.mouse.disableMobile)),
      e &&
        e.interactivity &&
        e.interactivity.mouse &&
        ('momentum' in e.interactivity.mouse &&
          (s.mouse.momentum = e.interactivity.mouse.momentum),
    ...
    if (s) {
      let i = s.parentLayer ? s.getParent() : null,
        ...
        a =
          ...
          i.effects &&
          i.effects.length &&
          i.getChildEffectItems().filter((h) => X(h)).length
      for (; s && !X(s) && !r && !a; )
        t++,
          (s = e[t]),
          s &&
  ...
  createPlane(e, t, s) {
    let i
    e.isElement
      ? e.compiledFragmentShaders.length
        ? (i = this.getEffectParams(e))
        : e.displace === 0 && e.blendMode === 'NORMAL' && !e.mask
        ? (i = Mt)
        : (i = Ct)
      : (i = this.getEffectParams(e, s ? s.index : null)),
      (i.watchScroll = !1)
  ...
  createPingPongPlane(e, t, s) {
    ...
    const r = new vt(this.curtain, this.curtain.container, i),
      a = e.getParent()
    if (r)
      return (
        (r.userData.id = e.local.id),
        ...
        r
          ...
          .onRender(() => this.setEffectPlaneUniforms(r, e)),
        r
      )
  }
  ...
  handleElementPlane(e, t) {
    ...
    if (
      ...
      let a = i.length + 1,
        ...
        l = o ? this.history.find((d) => d.local.id === o.userData.id) : null
      if (e.mask) {
        ...
        if (e.effects.length) {
          const c = e
            .getChildEffectItems()
            .filter((u) => !u.isMask)
            .reduce((u, f) => u + f.getPlanes().length, 0)
      ...
      if (e.mask) {
        let d =
          l.getPlanes().length +
          l.getChildEffectItems().reduce((c, u) => c + u.getPlanes().length, 0)
  ...
  handleChildEffectPlane(e, t, s) {
    ...
    let a = this.getRenderTargets()[t - 1],
      h = this.curtain.planes.find(
        (f) => f.type === 'PingPongPlane' && f.userData.id === e.local.id
      ),
      o = r.effects.filter((f) => {
    ...
    h &&
      ...
      i.userData.includeBg &&
        i.loadCanvas(r.local.canvas, {
          premultipliedAlpha: !0,
          sampler: 'uBgTexture',
        }),
      i && a && (l || s.passIndex > 0)
  ...
  isNotReady(e) {
    const t = this.history.find((h) => h.local.id === e.userData.id),
  ...
  handleStateEffects(e, t) {
    if (
      ...
      !t.states || !t.states.appear || !t.states.appear.length)
    )
      return !1
  ...
  setElementPlaneUniforms(e, t) {
    ;(e.uniforms.mousePos.value.x =
      this.mouse.pos.x / (this.element.offsetWidth * 0.5)),
      (e.uniforms.mousePos.value.y =
        1 - this.mouse.pos.y / (this.element.offsetHeight * 0.5)),
      ...
      !e.userData.isReady &&
        ...
        (e.uniforms.axisTilt.value = t.axisTilt || 0),
        e.renderOrder === 0
        ...
        e.uniforms.blendMode &&
          (e.uniforms.blendMode.value = Object.keys(Dt).indexOf(t.blendMode)),
  ...
  setEffectPlaneUniforms(e, t) {
    if (
      ...
      e.uniforms.mousePos &&
        ...
        (e.uniforms.mousePos.value.y =
          1 - this.mouse.pos.y / (this.element.offsetHeight * 0.5))),
      e.uniforms.previousMousePos && this.mouse.trail.length > 3)
    ) {
      let s = this.mouse.trail.at(3)
      ;(e.uniforms.previousMousePos.value.x = s[0]),
        (e.uniforms.previousMousePos.value.y = s[1])
    }
    ;(e.uniforms.resolution.value.x = this.curtain.canvas.width),
      (e.uniforms.resolution.value.y = this.curtain.canvas.height)
  }
  isHiddenFirstChildEffect(e) {
    return e.parentLayer && e.getParent().effects.length > 1
      ? e.getParent().effects.indexOf(e.parentLayer) === 0
      : !1
  }
  removeRenderTargets() {
  ...
  handleArgs(e) {
    ;(e.reorder || (e.changed && this.isHiddenFirstChildEffect(e.changed))) &&
      (this.removeRenderTargets(), this.clearAllTextures()),
      e.changed &&
        this.isHiddenFirstChildEffect(e.changed) &&
  ...
  getTextureParams(e, t, s) {
    const i = {
      ...
      r = e[t],
      a = e[t + 1]
        ? this.history.find((o) => o.local.id === e[t + 1].userData.id)
        : null
    return (
...
function ts() {
  window.addEventListener('mousemove', Pe),
    ...
    window.addEventListener('routeChange', Vt),
    oe() || window.addEventListener('resize', qt),
    document.addEventListener(K, Yt, !1)
}
function ss(n, e, t) {
  return (
    Q([n.offsetWidth, n.offsetHeight])[0] / n.offsetWidth,
    {
...
function is(n, e, t) {
  ...
  return (
    t
      ? (s = t)
      : (s = `https://storage.googleapis.com/unicornstudio-production/embeds/${n}${
          e ? '?' + e : ''
        }`),
    fetch(s)
      .then((i) => i.json())
      .then((i) => i)
      .catch((i) => console.error('Error fetching data:', i))
  )
}
function rs(n) {
  ...
  return new Promise((s, i) => {
    is(e, t, n.filePath)
      .then((r) => {
        const a = r.options || {},
          h = es(n.element) ? n.element : document.getElementById(n.elementId)
        if (!h) {
          i(
            new Error(
              `Couldn't find an element with id '${n.elementId}' on the page.`
            )
          )
          return
        }
        const o = Ae(),
          l = zt(
            ...
            ss(
              h,
              n.scale || a.scale || 1,
              n.dpi || Math.min(1.5, window.devicePixelRatio)
            )
          )
        kt(l.filter((c) => c.layerType === 'text')),
          Ft(l.filter((c) => c.layerType === 'text'))
        const d = new Jt({
          id: o,
          fps: n.fps || a.fps || 60,
          dpi: n.dpi,
        ...
        L.push(d),
          (d.history = l),
          (d.mouse.recordTrail = d.history.find((c) => c.type == 'mouse')),
...
ts()
export { rs as addScene, os as destroy, ls as init }
